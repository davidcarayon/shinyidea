...
RUN apt-get update && apt-get install -y  git-core libcurl4-openssl-dev libgit2-dev libicu-dev libssl-dev libxml2-dev make pandoc pandoc-citeproc zlib1g-dev libpoppler-cpp-dev libmagick++-dev cmake && rm -rf /var/lib/apt/lists/*
...
RUN Rscript -e 'remotes::install_github("davidcarayon/ShinyIDEA@7b55dd4ad258fa4808887c99effd31f709df872f")'
